...
public class Day1 {
    ...
    static List<Integer> notes = new ArrayList<>(Arrays.asList(1914,
            1931,
            1892,
            1584,
            1546,
        ...
        for (int i = 0; i < notes.size(); i++) {
            for (int ii = i + 1; ii < notes.size(); ii++) {
                if (notes.get(i).intValue() + notes.get(ii).intValue() == 2020) {
                    System.out.println(notes.get(i).intValue() * notes.get(ii).intValue());
                }
            }
        }
    }
            ...
            for (int ii = i + 1; ii < notes.size(); ii++) {
                for (int iii = i + 2; iii < notes.size(); iii++) {
                    if (notes.get(i).intValue() + notes.get(ii).intValue() + notes.get(iii).intValue() == 2020) {
                        System.out.println(notes.get(i).intValue() * notes.get(ii).intValue() * notes.get(iii).intValue());
                        break;
                    }
                }
            }
